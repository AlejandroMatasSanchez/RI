...
import uo.ri.cws.application.service.vehicle.crud.commands.FindVehicleById;
...
public class VehicleCrudServiceImpl implements VehicleCrudService {
	...
	@Override
	public Optional<VehicleDto> findById(String vehicleId) throws BusinessException {
		return executor.execute(new FindVehicleById(vehicleId));
	}
